...
root_agent = Agent(
    ...
    instruction=(
        ...
        "The 'tools' field for sub-agents can include: 'YahooFinanceNewsTool', 'get_price', 'BraveSearchTool', 'ScrapeWebsiteTool'. "
        ...
        "2. A .env file containing GOOGLE_GENAI_USE_VERTEXAI=FALSE, GOOGLE_API_KEY=the_value_from_json, and BRAVE_API_KEY if BraveSearchTool is used. "
