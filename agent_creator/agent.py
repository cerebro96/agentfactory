...
root_agent = Agent(
    ...
    instruction=(
        ...
        "The 'tools' field for sub-agents can include: 'YahooFinanceNewsTool', 'get_price', 'BraveSearchTool', 'ScrapeWebsiteTool', 'EXASearchTool', 'hyperbrowser_tool'. "
        ...
        "2. A .env file containing GOOGLE_GENAI_USE_VERTEXAI=FALSE, GOOGLE_API_KEY=the_value_from_json, BRAVE_API_KEY if BraveSearchTool is used, EXA_API_KEY if EXASearchTool is used, and HYPERBROWSER_API_KEY if hyperbrowser_tool is used. "
